...
from utils.general import (LOGGER, check_dataset, check_file, check_git_status, check_img_size, check_requirements,
                           ...
                           print_args, strip_optimizer, make_fold)
...
def train_one_fold(train_df, valid_df, hyp, opt, device, callbacks):
    ...
    # Process 0
    if RANK in [-1, 0]:
        val_loader, _ = create_dataloader(valid_df, imgsz, batch_size // WORLD_SIZE * 2, gs, single_cls,
...
def main(opt, callbacks=Callbacks()):
    ...
    for fold in range(n_fold):
        ...
        train_one_fold(train_df, valid_df, opt.hyp, opt, device, callbacks)
